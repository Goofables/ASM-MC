execute if score Debug Registers matches 3.. run say Pushing regs
...
execute positioned ~-1 ~ ~ if block ~ ~ ~ air positioned ~8 ~ ~-1 if score bits Registers matches 1.. run function asm:inst/push_step
execute positioned ~-1 ~ ~ unless block ~ ~ ~ air if score bits Registers matches 1.. run function asm:inst/push_step
